class RefereesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @referee.save
        format.html { redirect_to referees_url, notice: "Referee was successfully created." }
  ...
  def update
    respond_to do |format|
      if @referee.update(referee_params)
        format.html { redirect_to referees_url, notice: "Referee was successfully updated." }
  ...
  private
    ...
    def referee_params
      params.require(:referee).permit(:first_name, :last_name, :email, :phone, :photo)
    end
end
