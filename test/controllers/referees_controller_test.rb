...
class RefereesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create referee" do
    assert_difference('Referee.count') do
      post referees_url, params: { referee: { email: @referee.email, first_name: @referee.first_name, last_name: @referee.last_name, phone: @referee.phone } }
    end
  ...
  test "should update referee" do
    patch referee_url(@referee), params: { referee: { email: @referee.email, first_name: @referee.first_name, last_name: @referee.last_name, phone: @referee.phone } }
