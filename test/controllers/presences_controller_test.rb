...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { game_id: @presence.game_id, player_id: @presence.player_id, state: @presence.state } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { game_id: @presence.game_id, player_id: @presence.player_id, state: @presence.state } }
