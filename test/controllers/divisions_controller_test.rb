...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { league_id: @division.league_id, name: @division.name, type: @division.type } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { league_id: @division.league_id, name: @division.name, type: @division.type } }
