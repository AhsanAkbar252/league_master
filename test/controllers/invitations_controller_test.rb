...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { game_id: @invitation.game_id, referee_id: @invitation.referee_id, state: @invitation.state } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { game_id: @invitation.game_id, referee_id: @invitation.referee_id, state: @invitation.state } }
